...
const canBlockInterpret = pairs >= TARGET_PAIRS_FOR_INTERPRET;
  ...
  try {
    const kickoffInstruction =
      'Задай один первый вопрос для начала анализа фрагмента сна. ' +
  'Спроси о самом ярком или необычном образе из сна. ' +
  'Один простой вопрос, без преамбулы, тёплым тоном.';

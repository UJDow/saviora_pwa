...
const canBlockInterpret = pairs >= TARGET_PAIRS_FOR_INTERPRET;
  ...
  try {
    const kickoffInstruction =
      'Начни анализ с вопроса о самом ярком или необычном образе из ЭТОГО КОНКРЕТНОГО ФРАГМЕНТА сна. ' +
  'Используй один из разных типов вопросов: "Что для тебя значит [образ]?" или "Какие ощущения вызывает [образ]?" или "Почему именно [деталь]?". ' +
  'Один простой вопрос без преамбулы, без готовой интерпретации. ' +
